...
from CTRL.networks.resnet_org import model_dict
from CTRL.networks.resnet_cifar import model_dict as model_dict_cifar
from CTRL.utils.util import AverageMeter, save_model
...
class CLModel(nn.Module):
    def __init__(self, args):
        ...
        # Build torchvision resnet exactly like SimCLRBase
        ...
        for epoch in range(self.args.start_epoch, self.args.epochs):
            ...
            for i, (images, __, _) in enumerate(train_loader):  #frequency backdoor has been injected
                ...
                if self.args.method == 'simclr':
                    ...
                    features = torch.stack([z1, z2], dim=1)  # [B,2,feature_dim]
                    loss, _, _ = model.criterion(features)
