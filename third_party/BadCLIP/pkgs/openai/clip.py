...
from BadCLIP.utils import config
...
class Processor:
    def __init__(self, model):
        ...
        self.transform_tensor= Compose([Resize(model.visual.input_resolution, interpolation = Image.BICUBIC), CenterCrop(model.visual.input_resolution), Normalize((0.48145466, 0.4578275, 0.40821073), (0.26862954, 0.26130258, 0.27577711))])
