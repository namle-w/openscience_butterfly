from .simsiam import SimSiam, projection_MLP, prediction_MLP
from .byol import BYOL
# from .simclr import SimCLR
import torch
from torch import nn
from .backbones import resnet18, resnet34, resnet50
